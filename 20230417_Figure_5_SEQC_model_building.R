...
# #build AIMS model using high expressed genes
# dat_for_model <- tumor_expr[select_genes(tumor_expr),]
# datset_for_model <- list(x=dat_for_model,y=cluster_sample_subtypes)
# save(datset_for_model,datset_for_model_intrinsic_g,
#      file = "../Results/SEQC_datset_high_expr_for_model_and_dataset_for_model_intrinsic_g.RData")
# 
# res_prefix <- "SEQC_AGR_BGI_Z_score_AGR_model_high_expr"
# 
# 
# set.seed(12345678)
# setwd("/mnt/Miscrosoft/Brease_Cancer_subtyping/Results/")
