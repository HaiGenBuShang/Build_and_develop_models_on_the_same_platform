...
#array and RNA-seq PAM predicting kappa
res$pam_compre
#array and RNA-seq PAM + Cor predicting kappa
res$cor_compare


res <- compare_array_RNA_Seq_ClaNC_PAM_Cor(ClaNC_and_PAM_training_and_test_res = ClaNC_and_PAM_train,
                                           expr_dat = RNA_seq_expr)
#array and RNA-seq ClaNC predicting kappa
res$ClaNC_compare$ClaNC_compare
#array and RNA-seq ClaNC + PAM predicting kappa
res$ClaNC_PAM_and_ClaNC_PAM_Cor_compare$pam_compre
#array and RNA-seq ClaNC + PAM + Cor predicting kappa
