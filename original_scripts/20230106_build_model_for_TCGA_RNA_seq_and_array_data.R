#****************************************************************************
#*build model to test the predicting consistency for TCGA RNA-seq and array
#****************************************************************************
...
# a <- predict.one.vs.all.tsp(D = dat_for_model,GeneName = rownames(dat_for_model),
...
load(paste0(res_prefix_intrinsic,"_AIMS_training_res.RData"))
# a <- predict.one.vs.all.tsp(D = dat_for_model,GeneName = rownames(dat_for_model),
#                             one.vs.all.tsp = train_and_test_res_intrinsic$training_res$final_model)

a <- predict.one.vs.all.tsp(D = train_and_test_res_intrinsic$train_data,
                            GeneName = rownames(train_and_test_res_intrinsic$train_data),
                            one.vs.all.tsp = train_and_test_res_intrinsic$training_res$final_model)
...
# load("TCGA_RNA_seq_and_array.CV.kf.10.num.features.50.RData")
# load("TCGA_RNA_seq_and_array.CV.kf.10.num.features.50_cv_and_final_model.RData")
