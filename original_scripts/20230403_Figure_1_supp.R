...
pdf("../Results/Figure/Figure_1d_supp_dendrogram.pdf",width = 20,height = 10)
clustering_res %>%  
...
pdf("../Results/Figure/Figure_1d_median_centering_dendrogram.pdf",width = 20,height = 10)
...
pdf("../Results/Figure/Figure_1d_mean_centering_dendrogram.pdf",width = 20,height = 10)
